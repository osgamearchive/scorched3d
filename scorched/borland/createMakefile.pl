...
print OUT "DXSDKDIR = L:\\dx8\\DXF\\DXSDK\n";
print OUT "\n\n";
...
print OUT "LINKLIBS = import32.lib + cw32mt.lib + dxguid.lib + sdl.lib + sdlmain.lib + SDL_mixer.lib + SDL_net.lib\n";
print OUT "CC = \$(BORLANDDIR)\\Bin\\bcc32.exe\n";
print OUT "INCLUDE = -I..\\src -I\$(DXSDKDIR)\\include -I\$(BORLANDDIR)\\Include -I..\\visualc\\include\n";
print OUT "LIBS = -L\$(BORLANDDIR)\\lib -L\$(BORLANDDIR)\\dxlib -L\$(BORLANDDIR)\\sdllib\n";
print OUT "DEFINES = -DNO_FLOAT_MATH -DCOMPILED_FROM_DSP -D_NO_SERVER_ASE_ -D__MSC;INC_OLE2;__WIN95__;__WINDOWS__;WIN32;__BIDE__;dDOUBLE\n";
print OUT "DEFINESscorchedsvr = \$(DEFINES) -DSCORCHED_SERVER\n";
print OUT "DEFINESscorched = \$(DEFINES)\n";
print OUT "CCFLAGS = \$(INCLUDE) -a8 -5 -tWM -W -w -w! -w-inl -w-8022 -w-8008 -w-8071 -w-8084 -w-8017 -w-8001 -w-8060 -w-rch -w-aus -w-par -v \n";
