...
print OUT "LINKLIBS = -pthreads -lGL -lGLU -lSDL -lXm -lXpm -lXmu -lXext -lXt -lSM -lICE -lX11 -ljpeg -lz -lposix4 -lnsl -lsocket -ldl -lm -lSDL_mixer -lSDL_net -lpthread -L/lib/X11 -R/lib/X11 -L/opt/SDL/lib -R/opt/SDL/lib /opt/wxGTK-2.4.1/lib/libwx_gtk-2.4.so.0.0.0 -L/usr/cisco/packages/gtk+/gtk+-1.2.10/lib -L/usr/cisco/packages/glib/glib-1.2.10/lib -lglib -lgthread -lgtk -lgdk\n";
print OUT "\n";
