...
bool GLJpg::loadFromFile(const char * filename, const char *alphafilename, bool invert)
{
	GLJpg bitmap;
...
void GLJpg::createBlankInternal(int width, int height, bool alpha, unsigned char fill)
{
	clear();
	width_ = width;
	height_ = height;
...
bool GLJpg::loadFromFile(const char * filename, bool readalpha)
{
...
bool GLJpg::loadFromBuffer(NetBuffer &buffer, bool readalpha)
{
