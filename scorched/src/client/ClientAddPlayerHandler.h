...
#ifndef _ClientAddPlayerHandler_h
#define _ClientAddPlayerHandler_h

#include <coms/ComsMessageHandler.h>

class ClientAddPlayerHandler  : 
...
protected:
	static ClientAddPlayerHandler* instance_;
...
#endif // _ClientAddPlayerHandler_h
