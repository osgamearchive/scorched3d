...
GLTexture TreeModelRenderer::texture_;
GLuint TreeModelRenderer::treePine = 0;
GLuint TreeModelRenderer::treePineBurnt = 0;
GLuint TreeModelRenderer::treePineSnow = 0;
GLuint TreeModelRenderer::treePineSmall = 0;
GLuint TreeModelRenderer::treePineBurntSmall = 0;
GLuint TreeModelRenderer::treePineSnowSmall = 0;
GLuint TreeModelRenderer::treePalm = 0;
GLuint TreeModelRenderer::treePalmBurnt = 0;
GLuint TreeModelRenderer::treePalmSmall = 0;
GLuint TreeModelRenderer::treePalmBurntSmall = 0;
...
TreeModelRenderer::TreeModelRenderer(Target *target) :
	target_(target)
{
	pine = (0 != strstr(target->getModel().getTreeModel(), "pine"));
	snow = (0 != strstr(target->getModel().getTreeModel(), "snow"));
	burnt = false;
	rotation = RAND * 360.0f;
	size = 2.0f;
	color = Vector(1.0f, 1.0f, 1.0f);
}

TreeModelRenderer::~TreeModelRenderer()
{
}

void TreeModelRenderer::simulate(float frameTime)
{
}

void TreeModelRenderer::draw(float distance)
{
	...
	Vector &point = target_->getTargetPosition();
...
void TreeModelRenderer::drawSecond(float distance)
{
}

void TreeModelRenderer::draw2d()
{
}

void TreeModelRenderer::shieldHit()
{
}
