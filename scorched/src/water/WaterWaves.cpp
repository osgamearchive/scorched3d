...
void WaterWaves::generateWaves(float waterHeight, ProgressCounter *counter)
{
	...
	GLImageHandle waves1 = GLImageFactory::loadAlphaImageHandle(
		getDataFile("data/textures/waves.bmp"));
	GLImageHandle waves2 = GLImageFactory::loadAlphaImageHandle(
		getDataFile("data/textures/waves2.bmp"));
