...
#if !defined(__INCLUDE_ShotProjectileLeapFrogh_INCLUDE__)
#define __INCLUDE_ShotProjectileLeapFrogh_INCLUDE__

#include <actions/ShotProjectileExplosion.h>

class ShotProjectileLeapFrog : public ShotProjectileExplosion
{
public:
