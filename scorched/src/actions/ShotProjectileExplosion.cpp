...
bool ShotProjectileExplosion::writeAction(NetBuffer &buffer)
{
...
bool ShotProjectileExplosion::readAction(NetBufferReader &reader)
{
...
void ShotProjectileExplosion::collision(Vector &position)
{
