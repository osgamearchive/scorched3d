...
OptionsDisplay::OptionsDisplay() :
	...
	onlineColor_(options_, "OnlineColor",
		"The tank color that will be used for all online (non-team) games.", RAccess | NoRestore, Vector::nullVector, true),
	...
	fullScreen_(options_, "FullScreen", 
		"Run the game in a full screen mode.", RAccess, true),
	...
	fullClear_(options_, "FullClear", 
		"Completely clear the screen before drawing each frame", RWAccess, true),
	...
	depricatedNoGLCubeMap_(options_, "NoGLCubeMap",
		"Draw the water without using cubemap relfections.", OptionEntry::DataDepricated, false),
	depricatedNoGLSphereMap_(options_, "NoGLSphereMap",
		"Draw the water without using sphere map relfections.", OptionEntry::DataDepricated, false),
	...
	drawCollisionSpace_(options_, "DrawCollisionSpace",
		"Show object collision space", RWAccess, false),
	...
	drawMovement_(options_, "DrawMovement",
		"Draw the movement paths", RWAccess, false),
