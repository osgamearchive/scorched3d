...
OptionsGame::OptionsGame() :
	...
	keepAliveTime_(options_, "KeepAliveTime",
		"The amount of time between each client keep alive message", 0, 2),
	keepAliveTimeoutTime_(options_, "KeepAliveTimeoutTIme",
		"The amount of time the server will allow without receiving a keep alive message", 0, 0),
	...
	registeredUserNames_(options_, "RegisteredUserNames",
		"Only allow prefered players to use their own player names", 0, false),
	preferedPlayers_(options_, "PreferedPlayers",
		"Only allow prefered players to connect", 0, false),
