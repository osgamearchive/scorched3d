...
void LandscapeObjectsEntryTree::render(float distance)
{
	...
	if (!pineTextureA_.textureValid())
	{
		...
		glNewList(treePalmBList = glGenLists(1), GL_COMPILE);
			...
			drawPineLevel(0.164f, 0.836f, 0.8f, 0.5f, 0.6f, 0.164f, 8.0f, true);
			drawPineLevel(0.164f, 0.836f, 0.7f, 0.5f, 0.8f, 0.164f, 8.0f, true, 15.0f);
		glEndList();
		glNewList(treePalmB2List = glGenLists(1), GL_COMPILE);
			drawPalmTrunc(0.07f, 0.5f, 5.0f, 0.664f, 0.0f, 0.172f, 0.656f);
			drawPineLevel(0.5f, 0.836f, 0.8f, 0.5f, 0.6f, 0.164f, 8.0f, true);
			drawPineLevel(0.5f, 0.836f, 0.7f, 0.5f, 0.8f, 0.164f, 8.0f, true, 15.0f);
		glEndList();
		glNewList(treePalmB3List = glGenLists(1), GL_COMPILE);
			drawPalmTrunc(0.07f, 0.5f, 5.0f, 0.664f, 0.0f, 0.172f, 0.656f);
			drawPineLevel(0.836f, 0.836f, 0.8f, 0.5f, 0.6f, 0.164f, 8.0f, true);
			drawPineLevel(0.836f, 0.836f, 0.7f, 0.5f, 0.8f, 0.164f, 8.0f, true, 15.0f);
		glEndList();
		glNewList(treePalmB4List = glGenLists(1), GL_COMPILE);
			drawPalmTrunc(0.07f, 0.5f, 5.0f, 0.664f, 0.0f, 0.172f, 0.656f);
			drawPineLevel(0.164f, 0.5f, 0.8f, 0.5f, 0.6f, 0.164f, 8.0f, true);
			drawPineLevel(0.164f, 0.5f, 0.7f, 0.5f, 0.8f, 0.164f, 8.0f, true, 15.0f);
		glEndList();
		glNewList(treePalmB5List = glGenLists(1), GL_COMPILE);
			drawPalmTrunc(0.07f, 0.5f, 5.0f, 0.664f, 0.0f, 0.172f, 0.656f);
			drawPineLevel(0.5f, 0.5f, 0.8f, 0.5f, 0.6f, 0.164f, 8.0f, true);
			drawPineLevel(0.5f, 0.5f, 0.7f, 0.5f, 0.8f, 0.164f, 8.0f, true, 15.0f);
		glEndList();
		glNewList(treePalmB6List = glGenLists(1), GL_COMPILE);
			drawPalmTrunc(0.07f, 0.5f, 5.0f, 0.664f, 0.0f, 0.172f, 0.656f);
			drawPineLevel(0.164f, 0.164f, 0.8f, 0.5f, 0.6f, 0.164f, 8.0f, true);
			drawPineLevel(0.164f, 0.164f, 0.7f, 0.5f, 0.8f, 0.164f, 8.0f, true, 15.0f);
		glEndList();
